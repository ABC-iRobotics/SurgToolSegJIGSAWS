...
class UNet16(nn.Module):
    def __init__(self, num_classes=1, num_filters=32, pretrained=False):   # 32 for miccai Fales
        """
        :param num_classes:
        :param num_filters:
        :param pretrained:
        ...
        #self.center = DecoderBlock(512, num_filters, num_filters )
...
class LinkNet34(nn.Module):
    def __init__(self, num_classes=1, num_channels=3, pretrained=True):
        ...
        #filters = [8, 16, 32, 64] # for jigsaws
...
class UNet(nn.Module):
    ...
    def __init__(self,
                 ...
                 filters_base: int = 32,                        # 32 previously for miccai  eddig 16-al traineltem, mi a max? ==26
